...
5.110~113 visitedすべてに0を入れ初期化する
5.114 Stackを初期化
5.115 出発点をStackに入れる
5.117 Stackの中身が空になるまで以下を繰り返す
5.118 Stackから一つ取り出し、valに入れる
5.119 valを出力
5.120 駅の名前を出力
5.121 もしいったことがなかったら以下を実行する
5.122　visitedに1を入れる
5.123~125 隣接行列からいけるところを探し、見つかったらStackに入れる

5.198~201 visitedすべてに0を入れ初期化する
5.202 Queueを初期化
5.203 出発点をQueueに入れる
5.205 Queueの中身が空になるまで以下を繰り返す
5.206 Queueから一つ取り出し、valに入れる
5.207 valを出力
5.208 駅の名前を出力
5.209 もしいったことがなかったら以下を実行する
5.210　visitedに1を入れる
5.211 隣接行列からいけるところを探し、見つかったらQueueに入れる
