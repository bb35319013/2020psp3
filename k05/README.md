...
5.119 もしいったことがなかったら以下を実行する
5.120　visitedに1を入れる
5.121 隣接行列からいけるところを探し、見つかったらStackに入れる

5.196~199 visitedすべてに0を入れ初期化する
5.200 Queueを初期化
5.201 出発点をQueueに入れる
5.203 Queueの中身が空になるまで以下を繰り返す
5.204 Queueから一つ取り出し、valに入れる
5.205 もしいったことがなかったら以下を実行する
5.206　visitedに1を入れる
5.207 隣接行列からいけるところを探し、見つかったらQueueに入れる
