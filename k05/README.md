...
5.111~114 visitedすべてに0を入れ初期化する
5.115~119 fromすべてに0を入れる
5.121 Stackを初期化
5.122 出発点をStackに入れる
5.123 Stackの中身が空になるまで以下を繰り返す
5.124 Stackから一つ取り出し、valに入れる
5.125 もしいったことがなかったら以下を実行する
5.126　visitedに1を入れる
5.127 valを出力
5.128 駅の名前を出力
5.129~134 隣接行列からいけるところを探し、見つかったらStackに入れる。どこから来たかをfromに入れる
5.138~147 来たところを出力する

5.215~218 visitedすべてに0を入れ初期化する
5.219 Queueを初期化
5.220 出発点をQueueに入れる
5.221 Queueの中身が空になるまで以下を繰り返す
5.222 Queueから一つ取り出し、valに入れる
5.223 もしいったことがなかったら以下を実行する
5.224　visitedに1を入れる
5.225 valを出力
5.226 駅の名前を出力
5.227~230 隣接行列からいけるところを探し、見つかったらQueueに入れる
