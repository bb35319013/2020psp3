...
6.76~80 表を初期化
6.81 商品の数だけ以下を繰り返す
6.82~85 商品の値段が使えるお金より高い時は上の値をコピーする
6.86 使えるお金の数だけ以下を繰り返す
6.87~89 商品を入れ替えない場合のカロリーが商品を入れ替えた場合のカロリー以上の場合上の値をコピーする
6.90~92 商品を入れ替えない場合のカロリーが商品を入れ替えた場合のカロリーより小さいとき、入れ替えた場合のカロリーを入れる
6.97 最大取得カロリーを出力
